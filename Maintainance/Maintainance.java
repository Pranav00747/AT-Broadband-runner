...
class button4  extends JButton 
{
    private int alpha1, alpha2, size;
    private Color color;
    private String title;  

public button4(String text)
{
...
class pane4 extends JPanel
{
  ...
  public void paintComponent(Graphics g)
  {
     super.paintComponent(g);
      ...
      g2.drawString("Maintainance", 120, 30);
...
class Maintainance
{
 public Maintainance()
 {
   final JFrame f = new JFrame("Maintainance");
...
(Toolkit.getDefaultToolkit().getScreenSize().height-400)/2, 400, 400);
  ...
  pane4 p = new pane4(f);
  button4 save= new button4("Save"), close = new button4("Close");
