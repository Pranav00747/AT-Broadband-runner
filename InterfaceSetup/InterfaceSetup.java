...
class pane1 extends JPanel
{
  ...
  public void paintComponent(Graphics g)
  {
     super.paintComponent(g);
      ...
      g2.drawString("Inteface Setup", 120, 30);
...
class InterfaceSetup
{
 ...
 {
   final JFrame f = new JFrame("Interface Setup");
...
(Toolkit.getDefaultToolkit().getScreenSize().height-400)/2, 400, 400);
  ...
  pane1 p = new pane1(f);
  button1 save= new button1("Save"), close = new button1("Close");
